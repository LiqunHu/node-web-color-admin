...
const routes = [
  ...
  { path: '/common/system/OperatorControl', component: resolve => require(['@/views/common/system/OperatorControl'], resolve) },
  { path: '/common/system/UserProfile', component: resolve => require(['@/views/common/system/UserProfile'], resolve) },
